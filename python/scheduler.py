...
class ShiftScheduler:
    ...
    class W:
        ...
        # --- 不足/過剰 ---
        # v3.7.34: 不足発生 (シフトが出ないところがある) に対応
        # COVERAGE_UNDER を 5M → 15M に強化。過剰回避 (20M) は維持しつつ
        # 不足も強く避ける。物理的に不足する場合のみ最後の手段で許容。
        COVERAGE_UNDER      = 15_000_000  # スロット必要人数不足 (v3.7.34: 5M→15M)
