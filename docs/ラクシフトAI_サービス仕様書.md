...
| Tier 3 | 高度な制約（ポジション/人間関係） | 可 | ポジション（ホール等）別人数、NGペア、必須ペア（重いペナルティによるソフト制約） |
| Tier 4 | 最適化（コスト/均等/バランス） | 可 | シフト回数の均等化、人件費最小化、本人の希望時間優先 |
...
| 申請リスト | 休み希望の承認/却下 |
| 分析・レポート | 月間統計、AI診断 |
| スタッフ管理 | CRUD、評価、勤務条件、担当ポジション、人間関係（NG/必須ペア） |
